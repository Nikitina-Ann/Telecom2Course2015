...
Если соединение установлено клиент поочередно должен ввести ответы на слудеющие сообщения:   
...
Для тестирования приложения напишем unit тесты.   
Задавая определенные параметры входных значений, проверим работу отдельных функций, таких как установление соединения, аутотенфикация клиента, отправка сообщения, разрыв соединения.   
